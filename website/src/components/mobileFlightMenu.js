        ...
        <>
        {
            open ? (
                <div className="mobile-flight-menu mobile-flighted">
                    {/* <img src={flight} /> */}
                    <Link className="menu-link" id="big-menu-link" to="https://www.eventbrite.com/e/suds-on-the-square-beer-wine-and-music-festival-tickets-573040568767?aff=erelexpmlt">
